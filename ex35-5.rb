...
def gold_room()
   ...
   puts "how_much:  #{how_much}"
   # Basic check. Allows answers like "45rt" (but not "rt45")
   if how_much == 0 and next_move != "0"
      dead("Man, learn to type a number.")
   end
   # Advanced check. Doesn't allow answers like "45rt"
   if how_much.to_s != next_move
      dead("Man, learn to type a number.")
   end
